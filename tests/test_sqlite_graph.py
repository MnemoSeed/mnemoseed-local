...
def test_meta_file_contains_only_meta_tables(tmp_path):
    ...
    try:
        ...
        # v2/v5 are graph-only; v3/v4/v6/v7/v8/v9/v11/v12 are meta (identity chain
        ...
        # error-event ledger in v11, the provider fingerprint in v12)
        assert current_schema_version(conn, "meta") == 12
    finally:
        conn.close()
